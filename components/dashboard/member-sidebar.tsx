  ...
  return (
    <div className="member-glass-panel flex h-full flex-col rounded-[30px] backdrop-blur-3xl">
                ...
                <span
                  className={cn(
                    ...
                    active
                      ...
                      : "bg-[var(--member-icon-surface)] text-[var(--member-icon-foreground)]",
                  )}
                >
              ...
              <span className="relative z-10 inline-flex items-center gap-3">
                <span
                  className={cn(
                    ...
                    isGuidesRoute ? "bg-white/10" : "bg-[var(--member-icon-surface)]",
                  )}
                >
                    ...
                    return (
                      <Link
                        ...
                        style={
                          active
                            ? {
                                background: "var(--member-soft-button-hover-bg)",
                                boxShadow: "var(--member-soft-button-hover-shadow)",
                              }
                            : undefined
                        }
                      >
            ...
            >
              ...
              <span className="relative z-10 inline-flex items-center gap-3">
                <span
                  className={cn(
                    "inline-flex h-10 w-10 items-center justify-center rounded-2xl",
                    isAccountRoute ? "bg-white/10" : "bg-[var(--member-icon-surface)]",
                  )}
                >
      ...
      <div className="px-5 pb-5">
        ...
        <div className="member-glass-row mt-3 rounded-[24px] px-4 py-4">
